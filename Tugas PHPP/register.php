      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <a class="nav-link active btn btn-primary" href="beranda.php">Home</a>
    ...
    <div id="con">
      ...
      <div class="form-wrapper"> <!-- Added form wrapper -->
          ...
          <form class="text-light" action="" method="post">
            ...
            <label for="Username" class="form-label text-white">User<span class="text" style="color: #b79265;">name</span></label>
            ...
            <div class="form-group">
            <label for="password" class="form-label text-white">Konfirmasi <span class="text" style="color: #b79265;">Password</span></label>
